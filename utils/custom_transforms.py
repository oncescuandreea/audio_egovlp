...
def center_plus_four_crops(
    img: Tensor, size: List[int], margin_h: int, margin_w: int
    ...
    if crop_width + margin_w > image_width:
        ...
        raise ValueError(
            msg.format((margin_h, margin_w), size, (image_height, image_width))
        )
...
def center_plus_twohori_crops(
    img: Tensor, size: List[int], margin_w: int
